              ...
              <section className="space-y-6">
                <div className="lg:hidden">
                  {loadingGroups ? (
                    ...
                    groups.map((g) => (
                      <div key={g.id} onClick={() => { window.location.href = `http://localhost:5173/group/${g.id}` }} className="cursor-pointer rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-2xl hover:shadow-[0_24px_70px_rgba(0,0,0,0.45)] transition">
                ...
                <div className="space-y-3 text-sm text-white/85">
                  {loadingGroups ? (
                    ...
                    <div className="space-y-3">
                      {groups.map((g) => (
                        <div key={g.id} onClick={() => { window.location.href = `http://localhost:5173/group/${g.id}` }} className="cursor-pointer rounded-2xl border border-white/10 bg-white/5 p-4 hover:bg-white/8 transition">
