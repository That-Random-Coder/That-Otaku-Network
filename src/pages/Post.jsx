...
<div
            ...
            {...(ownerId ? { role: 'button', tabIndex: 0, onClick: () => { window.location.href = `http://localhost:5173/friend-profile/${encodeURIComponent(ownerId)}` }, onKeyDown: (e) => { if (e.key === 'Enter') { window.location.href = `http://localhost:5173/friend-profile/${encodeURIComponent(ownerId)}` } } } : {})} 
          >
